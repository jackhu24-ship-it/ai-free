...
set_cell(table.cell(0, 0), 'TGB 台灣金蜂股份有限公司', bold=True, size=16, align='center')
...
set_cell(table.cell(3, 0), '主旨: 深圳市科莱德电子有限公司 UTV 10.4吋中控主機 912791Y 等6項部件單價議決 呈核', size=11, align='left')
...
content_items = [
    ...
    (6, '       新供應商: 科莱德912791Y 進貨單價議決 CNY908 (NT4086)， 價差NT4419元.降幅51.96%'),
    (7, '二、現狀911913Y/ 960Y(前/後)攝像頭  供應商: 威騰 進貨價:CNY100.0 (NT450.0)'),
    (8, '       新供應商: 科莱德912793Y/794Y 進貨單價議決 CNY78 (NT351)， 價差NT99元.降幅22%'),
    (9, '三、現狀911914Y 天線盒   供應商: 威騰 進貨價:  CNY28 (NT126.0)'),
    (10, '       新供應商: 科莱德912789Y(含信號放大器)單價議決 CNY22.0 (NT99)， 價差NT27元.降幅21.42%'),
    (11, '四、現狀911915Y 中控轉接線   供應商: 威騰 進貨價:  CNY190 (NT855)'),
    (12, '       新供應商: 科莱德912790Y 進貨單價議決 CNY128 (NT576)， 價差NT279元.降幅32.63%'),
    (13, '五、911935Y 藍芽喇叭  供應商: 威騰 進貨價:  CNY361.8 (NT1628.1)'),
    (14, '        新供應商: 科莱德912792Y 進貨單價議決 CNY300 (NT1350)， 價差NT278.1元.降幅17.08%'),
    (15, '六、模具與開發費用：CNY188,100  (NT846,450)【開發費用CNY96,000、模具費CNY92,100】'),
    (16, '       1.模具費：塑膠面殼、塑膠底蓋、矽膠按鍵、防水密封圈模具CNY92,100(NT415,450)'),
    (17, '                    交貨達15,000台，返還模具費CNY92,100，另藍芽喇叭開發與模具費CNY10,000科萊德承擔'),
    (18, '       2.開發費：開發費用CNY146,000，科萊德承擔CNY50,000，TGB承擔CNY96,000'),
    (19, '        分二期給付：1.合約簽訂時 T/T給付50% CNY94,050 (NT423,225)'),
    (20, '                                 2.初樣合格 T/T給付50% CNY94,050 (NT423,225)'),
    (21, '七、初樣送樣數量: 付款啟動合約4個月內交付各3PCS(不付費)'),
    (22, '八、認證：CE→33,000、R10→36,000與FCC→24,000，認證費用小計 93,000 於啟動與獲證各50%T/T給付'),
    (23, '九、付款方式：FOB 深圳港'),
...
for row_idx, text in content_items:
    ...
    is_bold = row_idx == 30
    set_cell(table.cell(row_idx, 0), text, bold=is_bold, size=11, align='center' if is_center else 'left')
